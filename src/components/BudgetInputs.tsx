...
const BudgetInputs = ({ spent = 0 }: Props) => {
  ...
  const inputStyles = `bg-stone-950 rounded-2xl border border-stone-700 text-center outline-none focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`;
  ...
  return (
    <>
      <div className="flex flex-col items-center gap-4 w-full">
        <h1>Spending for the month left unaccounted for ${spent} </h1>
        ...
        <div className="bg-stone-900 p-4 rounded-2xl border border-stone-700 w-9/10">
          ...
          {transactions.map((t, i) => (
            <div
              className=" text-green bg-stone-900 rounded-2xl min-w-20 transition border border-stone-700 px-2"
              key={i}>
